    ...
    public void start(Stage theStage) 
    {
        ...
        new AnimationTimer()
        {
            public void handle(long currentNanoTime)
            {
                ...
                for(int i=0;i<16;i++) {
                	gc.drawImage(manycircs.get(i), 400+ 100 * Math.cos(i*Math.PI/8+3*t), 400+ 100 * Math.sin(i*Math.PI/8+3*t)+20*t);
                }
                for(int i=0;i<16;i++) {
                	gc.drawImage(manycircs.get((i+4)%16), 600+ 100 * Math.sin(i*Math.PI/8+3*t), 400+ 100 * Math.cos(i*Math.PI/8+3*t)+20*t);
                }
                for(int i=0;i<128;i++) {
                	gc.drawImage(manycircs2.get(i), 500+ 100 * Math.cos(i*Math.PI/64+3*t), 400+ 100 * Math.sin(i*Math.PI/64+3*t)+20*t -700);
                }
